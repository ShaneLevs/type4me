...
| 版本                                                         | 说明                                                         | 大小   |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------ |
| **[Type4Me-v1.5.0-local.dmg](https://github.com/joewongjc/type4me/releases/download/v1.5.0/Type4Me-v1.5.0-local.dmg)** | 内嵌 SenseVoice（实时流式识别展示） + Qwen3-ASR（完整语音校准），支持单选1个模型使用或一起用。开箱即用。 | ~1.2GB |
