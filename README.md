...
<table>
  <tr>
    <td align="center"><img src="docs/screenshots/settings-general.jpg" width="400" /><br /><b>通用设置</b><br />ASR 引擎、LLM 服务、偏好配置</td>
    <td align="center"><img src="docs/screenshots/settings-vocabulary.jpg" width="400" /><br /><b>词汇管理</b><br />ASR 热词、片段替换</td>
  </tr>
  <tr>
    <td align="center"><img src="docs/screenshots/settings-modes.jpg" width="400" /><br /><b>处理模式</b><br />自定义 Prompt、快捷键绑定</td>
    <td align="center"><img src="docs/screenshots/settings-history.jpg" width="400" /><br /><b>识别历史</b><br />统计数据、会话日志</td>
  </tr>
</table>
